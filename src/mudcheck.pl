...
# SETTING UP                                                            #
#                                                                       #
# After making the necessary changes to the vars below, and saving. You #
# type  crontab -e  to enter into editing mode of the cron. 
#########################################################################
# CHANGES AND HISTORY							#
#									#
...
$server		=	"mindcloud.kicks-ass.net";
$port		=	"4000";
...
$exec		=	"/home/jeff/mcloud/src/mcloud";

# Path where you want the mud logs to be kept.

$logdir		=	"/home/jeff/mcloud/log";

# Path where we should start the mud from.				#
$startPath	=	"/home/jeff/mcloud/area";
