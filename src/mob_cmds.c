...
void do_mptransfer( CHAR_DATA *ch, char *argument )
{
	...
	if ( room_is_private(victim, location) )
	    return;
    }
...
void do_mpcall( CHAR_DATA *ch, char *argument )
{
    ...
    OBJ_DATA *obj1, *obj2;
    PROG_CODE *prg;
    extern void program_flow( unsigned long, char *, CHAR_DATA *, OBJ_DATA *, ROOM_INDEX_DATA *, CHAR_DATA *, const void *, const void * );
