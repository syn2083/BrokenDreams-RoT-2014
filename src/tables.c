...
/*
	...
	good_recall_vnum,	evil_recall_vnum,
	pit_vnum,		morgue_vnum
    }
*/

    {
	"none",		"None",
	ROOM_VNUM_TEMPLE,	ROOM_VNUM_TEMPLEB,
	OBJ_VNUM_PIT,		ROOM_VNUM_MORGUE
    },
	...
	ROOM_VNUM_GOOD_NT,	ROOM_VNUM_EVIL_NT,
	OBJ_VNUM_PIT_NT,	ROOM_VNUM_MORG_NT
    },
...
const struct flag_type exbit1_flags[] =
{
    {	"newpk",		A,	TRUE	},
    {	"veteran",		B,	TRUE	},
    {	"killer",		C,	TRUE	},
